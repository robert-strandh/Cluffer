...
subclasses of \texttt{new-line:line} for which the item at a
particular position is computed differently, as is the case for the
standard line \seesec{sec-implementation-standard-line} then this
method must be replaced by a method for each subclass with a specific
way of computing the item count.
